...
public class JavaJAXRSSpecServerCodegen extends AbstractJavaJAXRSServerCodegen {
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(USE_JACKSON_ANNOTATIONS)) {
            useJacksonAnnotations = Boolean.valueOf(additionalProperties.get(USE_JACKSON_ANNOTATIONS).toString());
        }
        additionalProperties.put(USE_JACKSON_ANNOTATIONS, useJacksonAnnotations);
